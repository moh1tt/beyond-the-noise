...
These don't fit either active thesis. Not force-fitting them — they need their own conviction (or a decision to trim/exit).

- **SOFI** (-34.7%, -$355.71): largest dollar loss in the book. Q1 2026 was actually record-setting (revenue +41% YoY, EBITDA +62%), but the stock is down because management held guidance flat after the market had priced in 2026 Fed rate cuts that haven't materialized — effectively a stealth guidance cut for a rate-sensitive lender. Consensus is Hold with meaningful implied upside from here, but this needs an explicit decision: average down, hold and wait for a rate-cut catalyst, or cut the loss. See [tickers/SOFI.md](../tickers/SOFI.md).
- **LIN** (+1.9%): high-quality industrial gas compounder with a real but secondary AI/semiconductor-fab angle (long-term gas supply contracts to Intel/TSMC/Samsung). Could anchor a future "quality compounders" thesis. See [tickers/LIN.md](../tickers/LIN.md).
- **WMT** (+5.1%): defensive compounder, strong Q1 (comps +4.1%, eCommerce +26%), expanding drone delivery with Wing/Alphabet. Same — candidate for a future "quality compounders" thesis. See [tickers/WMT.md](../tickers/WMT.md).

## Notes

- The 2026-05-11 rotation (selling PLTR and BKNG to fund ENTG/POWL/GLW/CEG) marks the origin of the AI Infrastructure Buildout thesis — see that thesis file for the full picture.
- GLW and CEG positions include small DRIP (dividend reinvestment) share fragments.
